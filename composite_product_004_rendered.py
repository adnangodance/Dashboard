...
RENDER = Path("/Users/adnan/.codex/generated_images/019fdd5a-c518-7101-b88b-b6693cf9c1f9/exec-adc47531-a652-4e76-b97b-9a0dcfd86d3c.png")
...
def main():
    ...
    # Crop only the AI-rendered physical label; exclude its opaque black backdrop.
    ...
    # Feathered rounded mask keeps the original bottle and transparent canvas intact.
